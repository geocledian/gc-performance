...
function gcGetBaseURL() {
    ...
    let scriptURL = document.getElementById("gc-performance-init");
...
function initComponent() {
    ...
    */
    ...
    // change for DEBUG to js/gc-performance.js
    loadJSscript("js/gc-performance.js", function() {
        ...
        vmRoot = new Vue({
            ...
            i18n: i18n,
            created() {
              console.debug("gc-performance-init created!");
...
function loadJSscript (url, callback) {
    /* 
      ...
      */
    console.debug("gc-performance-init - loadJSscript()");
    let script = document.createElement("script");  // create a script DOM node
    script.type = 'text/javascript';
